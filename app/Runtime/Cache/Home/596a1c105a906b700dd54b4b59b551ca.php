...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="/tp/Public/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="/tp/Public/css/login.css">
    <link rel="stylesheet" type="text/css" href="/tp/Public/js/uploadify/uploadify.css">
    <script type="text/javascript">
    var ThinkPHP={
        'IMG' : '__IMG__',
        'MODULE':'/tp/index.php/Home',
    }
    </script>
    <title>登录首页</title>
</head>
...
<div class="modal fade" id="fail_modal">
  <div class="modal-dialog">
    ...
    <script type="text/javascript" src="/tp/Public/bootstrap/js/bootstrap.js"></script>
    <script type="text/javascript" src="/tp/Public/js/jquery.validate.js"></script>
